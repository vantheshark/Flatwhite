...
C:\tools\nuget pack Flatwhite\Package.nuspec -Version %VERSION% -NonInteractive
C:\tools\nuget pack Flatwhite.Autofac\Package.nuspec -Version %VERSION% -NonInteractive
C:\tools\nuget pack Flatwhite.WebApi\Package.nuspec -Version %VERSION% -NonInteractive
